...
require_once dirname(__DIR__)  . DIRECTORY_SEPARATOR . 'class' . DIRECTORY_SEPARATOR . 'file' . DIRECTORY_SEPARATOR . 'apifile.php';
require_once dirname(__DIR__)  . DIRECTORY_SEPARATOR . 'class' . DIRECTORY_SEPARATOR . 'cache' . DIRECTORY_SEPARATOR . 'apicache.php';
require_once dirname(__DIR__)  . DIRECTORY_SEPARATOR . 'class' . DIRECTORY_SEPARATOR . 'radio.php';
require_once dirname(__DIR__)  . DIRECTORY_SEPARATOR . 'include' . DIRECTORY_SEPARATOR . 'simple_html_dom.php';
